      ...
      <div className="flex items-center gap-1.5">
        ...
        {tooltip && (
          <div className="relative">
            ...
            <div className="invisible peer-hover:visible absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-56 rounded-lg bg-[#1a1a1a] border border-[#333] px-3 py-2 text-xs text-gray-300 leading-relaxed shadow-xl z-50">
              {tooltip}
